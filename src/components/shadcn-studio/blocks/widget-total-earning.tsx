  ...
  return (
    <Card className={className}>
      <CardHeader className='flex items-center justify-between'>
        ...
        <DropdownMenu>
          <DropdownMenuTrigger render={<Button variant='ghost' size='icon' className='text-muted-foreground size-6 rounded-full' />}><MoreVertical /><span className='sr-only'>Menu</span></DropdownMenuTrigger>
        ...
        <div className='flex flex-col gap-1'>
          <div className='flex items-center gap-2'>
            ...
            <span className='flex items-center gap-1'>
              {trend === 'up' ? <ChevronUp className='size-4' /> : <ChevronDown className='size-4' />}
